...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>e6565358-2a66-4b4a-9722-de56a0368f2f</elementGuidId>
   ...
   <restUrl>${host}/competency/settings/competency-list/details/${id}?page=${page}&amp;limit=${limit}</restUrl>
