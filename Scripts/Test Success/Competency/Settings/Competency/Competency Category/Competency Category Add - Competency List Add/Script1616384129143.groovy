...
for (def datas : data.properties.getAt('allData')) {
    ...
    WebUI.scrollToElement(findTestObject('WEB/Competency/Settings/Competency/Competency Category/competency category - add - competency list header'), 
        5)

    WebUI.click(findTestObject('WEB/Competency/Settings/Competency/Competency Category/competency category - add - competency list add'))

    WebUI.click(findTestObject('WEB/Competency/Settings/Competency/Competency Category/competency category - add - competency list add - dropdown type'))

    WebUI.click(findTestObject('WEB/Competency/Settings/Competency/Competency Category/competency category - add - competency list add - type'))

    WebUI.click(findTestObject('WEB/Competency/Settings/Competency/Competency Category/competency category - add - competency list add - dropdown competency'))

    WebUI.click(findTestObject('WEB/Competency/Settings/Competency/Competency Category/competency category - add - comptency list add - competency'))

    WebUI.click(findTestObject('WEB/Competency/Settings/Competency/Competency Category/competency category - add - competency list add - submit'))
    ...
    CustomKeywords.'com.lawencon.util.ExcelUtils.writeToExcel'('C:\\Users\\Lawencon\\Test Cases - Competency.xlsx', 'Data - CC - Add CL', 
        nilai, idx, datas[4])
