...
for (def datas : data.properties.getAt("allData")) {
	...
	WebUI.setText(findTestObject('WEB/Login/input username'), datas[0], FailureHandling.CONTINUE_ON_FAILURE)
...
//CucumberKW.runFeatureFileWithTags('Include/features/Login/Login.feature', '@invalid')