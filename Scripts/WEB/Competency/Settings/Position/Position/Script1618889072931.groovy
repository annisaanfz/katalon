...
WebUI.click(findTestObject('WEB/Competency/Settings/Position/dropdown position'))

WebUI.click(findTestObject('WEB/Competency/Settings/Position/position - paginator - last'))