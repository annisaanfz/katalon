...
WebUI.click(findTestObject('WEB/Competency/Settings/Job Competency/Job Family/dropdown job family'))

WebUI.setText(findTestObject('WEB/Competency/Settings/Job Competency/Job Family/job family - search'), 'af')

WebUI.sendKeys(findTestObject('WEB/Competency/Settings/Job Competency/Job Family/job family - search'), Keys.chord(Keys.ENTER))