...
WebUI.callTestCase(findTestCase('WEB/Competency/Settings/Job Competency/Job Title/Job Title'), null)

WebUI.click(findTestObject('WEB/Competency/Settings/Job Competency/Job Title/job title - list to detail'))
